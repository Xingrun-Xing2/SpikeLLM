...
class QuantFalconMLP(nn.Module):
    def __init__(self, org_module: nn.Module,args=None):
        ...
        self.dense_h_to_4h = SpikeQuantLinear(org_module.dense_h_to_4h,args.weight_quant_params,args.act_quant_params)
        self.act = nn.GELU()
        self.dense_4h_to_h = SpikeQuantLinear(org_module.dense_4h_to_h,args.weight_quant_params,args.act_quant_params)
...
class QuantFalconAttention(nn.Module):
    def __init__(self,  config: FalconConfig, org_module: nn.Module, args=None):
        ...
        self.query_key_value = SpikeQuantLinear(org_module.query_key_value,args.weight_quant_params,args.act_quant_params)
        self.new_decoder_architecture = config.new_decoder_architecture
        self.multi_query = config.multi_query
        self.dense =SpikeQuantLinear(org_module.dense,args.weight_quant_params,args.act_quant_params)
